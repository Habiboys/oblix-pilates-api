...
const MEMBER_SESSIONS = [
  ...
  },
  {
    ...
    groupSessions: 4, // Group Class, sisa 6 (Renewal package 12 sessi)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 30, // 12 sesi total - 6 sisa = 6 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 12
  },
  ...
  },
  {
    ...
    groupSessions: 3, // Group Class, sisa 5 (Promo Ramadhan 12sesi)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 9, // 12 sesi total - 5 sisa = 7 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 6
  },
  {
    ...
    groupSessions: 1, // Group Class, sisa 4 (Promo 10 + 2)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 11, // 12 sesi total - 4 sisa = 8 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 6
  },
  ...
  },
  {
    ...
    groupSessions: 9, // Group Class, sisa 13 (Promo 10 + 2)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 3, // 12 sesi total - 13 sisa = 0 used (mungkin ada bonus)
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 6
  },
  ...
  },
  {
    ...
    usedGroupSessions: 5, 
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 2, 
    validPeriod: 24
  },
  {
    email: 'yuri.lian@yahoo.com',
    startDate: '2025-05-30', 
    groupSessions: 8, // Group Class, sisa 14 (Promo 20sesi)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 12, // 20 sesi total - 14 sisa = 6 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 12
  },
  {
    ...
    groupSessions: 4, // Group Class, sisa 8 (Renewal package 12 sessi)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 28, // 12 sesi total - 8 sisa = 4 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 12
  },
  {
    ...
    groupSessions: 3, // Group Class, sisa 8 (Promo 10 + 2)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 9, // 12 sesi total - 8 sisa = 4 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 6
  },
  {
    ...
    groupSessions: 6, // Group Class, sisa 10 (Promo 10+2)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 6, // 12 sesi total - 10 sisa = 2 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 6
  },
  {
    ...
    groupSessions: 17, // Group Class, sisa 25 (Promo unlimited 1 Tahun)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 38, // Unlimited, tidak ada used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 52 
  },
  {
    ...
    groupSessions: 6, // Group Class, sisa 9 (Promo 10+2)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 6, // 12 sesi total - 9 sisa = 3 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 6
  },
  ...
  },
  {
    ...
    groupSessions: 5, // Group Class, sisa 12 (Promo 10 + 2)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 15, // 12 sesi total - 12 sisa = 0 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 12
  },
  ...
  },
  {
    ...
    groupSessions: 7, // Group Class, sisa 10 (Promo 20sesi)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 13, // 20 sesi total - 10 sisa = 10 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 12
  },
  {
    ...
    groupSessions: 0,
    semiPrivateSessions: 0,
    privateSessions: 2, // Private 1:1, sisa 4 (Private 1:1 10sesi)
    usedGroupSessions: 0,
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 8, // 10 sesi total - 4 sisa = 6 used
    validPeriod: 10
  },
  {
    email: 'Vivianncen@gmail.com',
    startDate: '2025-05-28', 
    groupSessions: 1, // Group Class, sisa 5 (Promo 10 + 4)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 13, // 14 sesi total - 5 sisa = 9 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 8
  },
  ...
  },
  {
    ...
    startDate: '', 
    groupSessions: 44, 
    semiPrivateSessions: 30, 
    privateSessions: 0,
    usedGroupSessions: 14, 
    usedSemiPrivateSessions: 0, 
    usedPrivateSessions: 0,
    validPeriod: 12
  ...
  },
  {
    ...
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 9, // Unlimited, tidak ada used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 12
  },
  {
    ...
    startDate: '', 
    groupSessions: 25, // Ms Yulianti ada 2 entry: sisa 1 + sisa 20 = 21 total
    semiPrivateSessions: 0,
    privateSessions: 0,
  ...
  },
  {
    ...
    groupSessions: 23, // Group Class, sisa 26 (Promo 40sesi)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 17, // 40 sesi total - 26 sisa = 14 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 24
  },
  ...
  },
  {
    ...
    groupSessions: 0,
    semiPrivateSessions: 0,
    privateSessions: 4, // Private 1:1, sisa 7 (Private 10 + 2)
    usedGroupSessions: 0,
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 16, // 12 sesi total - 7 sisa = 5 used
    validPeriod: 12
  },
  {
    email: 'lindakris931966@gmail.com',
    startDate: '2025-05-07', 
    groupSessions: 10, // Group Class, sisa 11 (Promo 20sesi)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 10, // 20 sesi total - 11 sisa = 9 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 12
  },
...
//====sudah======
  {
    ...
    groupSessions: 18, // Group Class, sisa 12 (Promo 10 + 2)
    semiPrivateSessions: 0,
    privateSessions: 0,
    usedGroupSessions: 6, // 12 sesi total - 12 sisa = 0 used
    usedSemiPrivateSessions: 0,
    usedPrivateSessions: 0,
    validPeriod: 8
  },
