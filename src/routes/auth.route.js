...
const { register, login, refreshToken, forgotPassword, checkResetToken, resetPassword, checkPurchaseStatus, checkTokenStatus } = require('../controllers/auth.controller');
